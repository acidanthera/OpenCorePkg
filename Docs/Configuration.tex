...
\item
  ...
  When multiple ones are selected, comma (\texttt{,}) should be used as the splitter (e.g. \texttt{OCCPU,OCB,OCA}).
  \texttt{*} indicates all modules being logged.

  \emph{Note}: Acronyms of libraries can be found in the
  \hyperref[debug-target]{\texttt{Target}} section below.
