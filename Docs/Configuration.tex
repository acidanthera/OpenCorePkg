...
\item
  ...
  \emph{Note 3}: Some versions of Intel Visual BIOS (e.g. on Intel NUC) have an unfortunate bug whereby
  ...
  The best way to avoid this is to leave \texttt{LauncherOption} at \texttt{Disabled} on any version of
