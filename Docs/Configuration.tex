...
\item
  ...
  Ensure that CSM memory regions are marked as ACPI NVS to prevent \texttt{boot.efi} or
...
\begin{itemize}
  ...
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{FwRuntimeServices}} (\textbf{builtin})
  ...
  used due to the lack of \texttt{RDRAND} instruction support.
  \item \href{https://github.com/acidanthera/audk}{\texttt{HiiDatabase}} (\textbf{builtin})
  ...
  \item \href{https://github.com/acidanthera/audk}{\texttt{NvmExpressDxe}} (\textbf{builtin})
  ...
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{AppleUsbKbDxe}} (\textbf{builtin})
  ...
  a security audit.
  \item \href{https://github.com/acidanthera/audk}{\texttt{XhciDxe}} (\textbf{builtin})
...
To boot into Shell or any other tool directly save \texttt{Shell.efi}
...
sudo bless --verbose --file /Volumes/VOLNAME/DIR/Shell.efi \
...
\begin{itemize}
  \tightlist
  \item 
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{BootKicker}} (\textbf{builtin})
  --- Enter Apple BootPicker menu (exclusive for Macs with compatible GPUs).
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{ChipTune}} (\textbf{builtin})
  --- Test BeepGen protocol and generate audio signals of different style and length.
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{CleanNvram}} (\textbf{builtin})
  --- Reset NVRAM alternative bundled as a standalone tool.
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{FwProtect}} (\textbf{builtin})
  --- Unlock and lock back NVRAM protection for other tools to be able to get full NVRAM access
  when launching from OpenCore.
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{GopStop}} (\textbf{builtin})
  ...
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{HdaCodecDump}} (\textbf{builtin})
  --- Parse and dump High Definition Audio codec information (requires \texttt{AudioDxe}).
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{KeySupport}} (\textbf{builtin})
  --- Test keyboard input in \texttt{SimpleText} mode.
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{OpenCore Shell}} (\textbf{builtin})
  ...
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{VerifyMsrE2}} (\textbf{builtin})
