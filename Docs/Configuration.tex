...
\item
  ...
  If \texttt{true} the values \texttt{KeyInitialDelay} and \texttt{KeySubsequentDelay} are used.
  If \texttt{false} Apple default values of 500ms (\texttt{50}) and 50ms (\texttt{5}) are used.
