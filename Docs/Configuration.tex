...
\item
  ...
  \emph{Note}: When this option is enabled, \texttt{DisableIoMapper} must be disabled and
  \texttt{VT-d} must be enabled in BIOS. Otherwise, network cards will not function correctly.
