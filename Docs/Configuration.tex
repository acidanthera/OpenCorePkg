...
\item
  ...
  \textbf{Type}: \texttt{plist\ dict}\\
  \textbf{Failsafe}: None\\
  \textbf{Description}: Configure OpenCore's re-implementation of the Apple Event protocol
  based on the \hyperref[uefiappleinputprops]{AppleInput Properties} section below.
