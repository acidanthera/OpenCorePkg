...
\item
  ...
  otherwise equivalent to \texttt{Bootstrap}. This variant is useful for some Insyde firmwares,
...
\item \label{secureapplesb}
  ...
  Installing macOS with Apple Secure Boot enabled is not possible while using 
