...
\item
  ...
  Setting this value to any (random) non-zero 64-bit integer will allow using
  personalised Apple Secure Boot identifiers. This value set and
  \texttt{SecureBootModel} valid and not \texttt{Disabled} is equivalent to
  to ahieve \href{https://support.apple.com/en-us/HT208330}{\texttt{Full Security}}
  of Apple Secure Boot.

  \emph{Note}: You will have to reinstall the operating system or use the recovery
  after setting this value to non-zero.
...
\item
  ...
  \begin{itemize}
  \tightlist
  \item \texttt{Disabled} --- loading DMG images will fail.
  \item \texttt{Signed} --- only Apple-signed DMG images will load.
...
\item
  ...
  Defines Apple Secure Boot hardware model and policy. Specifying
  ...
  \item \texttt{j137} --- \texttt{iMacPro1,1}
  \item \texttt{j680} --- \texttt{MacBookPro15,1}
  \item \texttt{j132} --- \texttt{MacBookPro15,2}
  \item \texttt{j174} --- \texttt{Macmini8,1}
  \item \texttt{j140k} --- \texttt{MacBookAir8,1}
  \item \texttt{j780} --- \texttt{MacBookPro15,3}
  \item \texttt{j213} --- \texttt{MacBookPro15,4}
  \item \texttt{j140a} --- \texttt{MacBookAir8,2}
  \item \texttt{j152f} --- \texttt{MacBookPro16,1}
  \item \texttt{j160} --- \texttt{MacPro7,1}
  \item \texttt{j230k} --- \texttt{MacBookAir9,1}
  ...
  \emph{Note}: \texttt{Default} value will increase with time to support the latest
