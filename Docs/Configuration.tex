...
\item
  ...
  This is the minimal period AppleEvent polls pointer devices (e.g. mice, trackpads)
  for motion events. Defaults to 10 ms in the OpenCore AppleEvent implementation
  and to 2 ms in the OEM Apple implementation.
  ...
  This is the maximum period AppleEvent polls pointer devices (e.g. mice, trackpads)
  for motion events. The period is increased up to this value as long as the devices
  do not respond in time. Defaults to 80 ms in the OpenCore AppleEvent implementation
  and to 2 ms in the OEM Apple implementation.
  ...
  will be \texttt{1+4+8} (corresponding powers of two).
