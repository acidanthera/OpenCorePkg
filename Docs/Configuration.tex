...
\item
  ...
  \textbf{Type}: \texttt{plist\ integer}\\
  \textbf{Failsafe}: 1\\
  \textbf{Description}: Which KC to inject the kext into (1=PrelinkedKC, 2=SysKC, 3=AuxKC.)
...
\item
  ...
  \textbf{Type}: \texttt{plist\ integer}\\
  \textbf{Failsafe}: 1\\
  \textbf{Description}: Which KC to block the kext from (1=PrelinkedKC, 2=SysKC, 3=AuxKC.)
