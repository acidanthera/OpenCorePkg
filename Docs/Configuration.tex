...
\textbf{Organisation}. The codebase is primarily in \texttt{OpenCorePkg} repository,
which is the primary EDK II package. Some drivers can also be found in \texttt{AppleSupportPkg}.
\begin{itemize}
\tightlist
