...
\item
  ...
  \item In addition to the \texttt{msgbuf} boot argument, \href{https://github.com/acidanthera/DebugEnhancer}{DebugEnhancer}
    may also be used for more debug prints to be available.
