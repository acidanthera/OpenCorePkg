...
\item
  ...
  The patch changes the PMIO register base address from the default \texttt{0x3F8-0x3FF}
  assumed by XNU to the actucal one used by the PCI serial card, such that
...
\item
  ...
  \item \texttt{serial=VALUE} (configure serial logging mode)
