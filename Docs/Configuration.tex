...
\item
  ...
  \textbf{Description}: Target KC for the specific kernel extension. Ignored if running macOS 15 (Catalina) or older.

  \hypertarget{targetkc}Valid values:
...
\item
  ...
  \emph{Note}: Refer to the \hyperlink{targetkc}{\texttt{Add\ TargetKC} description} for valid values.
