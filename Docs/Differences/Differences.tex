...
%DIF DEL PreviousConfiguration.tex   Thu Feb 11 16:16:08 2021
%DIF ADD ../Configuration.tex        Thu Feb 11 16:19:44 2021
...
\item
  ...
  \textbf{Description}: Data to find. Must \DIFaddbegin \DIFadd{be }\DIFaddend equal to \texttt{Replace} in size.
...
\item
  ...
  \textbf{Type}: \texttt{plist\ data}\\
  \textbf{Failsafe}: Empty\DIFdelbegin \DIFdel{data}\DIFdelend \\
  \textbf{Description}: Data to find. \DIFdelbegin \DIFdel{This must }\DIFdelend \DIFaddbegin \DIFadd{Must be }\DIFaddend equal to \texttt{Replace} in size.
...
\item
  ...
  replacement) by obtaining the address of provided symbol name.
\DIFdelbegin \DIFdel{Can be set to
...
\item
  ...
  from GOP if available. \DIFdelbegin %DIFDELCMD < \item %%%
\item %DIFAUXCMD
\DIFdel{Set to empty string not to change screen resolution.
  }%DIFDELCMD < \item %%%
\item %DIFAUXCMD
\DIFdel{Set to }\DIFdelend \DIFaddbegin \DIFadd{Set to }\DIFaddend \texttt{Max} to \DIFdelbegin \DIFdel{try to use }\DIFdelend \DIFaddbegin \DIFadd{attempt using the }\DIFaddend largest
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Apple Boot Policy protocol with a builtin
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Apple Debug Log protocol with a builtin
  version.
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Apple Event protocol with a builtin
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Apple Framebuffer Info protocol with a builtin
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Apple Image Conversion protocol with a builtin
  version.
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Apple IMG4 Verification protocol with a builtin
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Apple RTC RAM protocol with \DIFaddbegin \DIFadd{a }\DIFaddend builtin
  version.
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Apple Secure Boot protocol with a builtin
  version.
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Apple SMC I/O protocol with a builtin
  version.
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Apple User Interface Theme protocol with a builtin
  version.
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Data Hub protocol with a builtin version.
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend Device Property protocol with a builtin
...
\DIFaddend \item
  ...
  }\DIFaddend to support custom cursor images for File Vault 2. Should be set to \texttt{true}
...
\item
  ...
  Should be set to \texttt{true} to ensure File Vault 2 compatibility on
  platforms \DIFdelbegin \DIFdel{providing broken }\DIFdelend \DIFaddbegin \DIFadd{with flawed }\DIFaddend SHA-1 \DIFdelbegin \DIFdel{hashing}\DIFdelend \DIFaddbegin \DIFadd{hash implementation}\DIFaddend . Can be diagnosed by invalid
  cursor size with \texttt{UIScale} set to \texttt{02}\DIFdelbegin \DIFdel{, in general platforms
  prior to }\DIFdelend \DIFaddbegin \DIFadd{. Platforms earlier
  than }\DIFaddend APTIO V (Haswell and older) are \DIFaddbegin \DIFadd{generally }\DIFaddend affected.

\item
  \texttt{OSInfo}\\
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: \DIFdelbegin \DIFdel{Forcibly reinstalls }\DIFdelend \DIFaddbegin \DIFadd{Replaces }\DIFaddend OS Info protocol with \DIFdelbegin \DIFdel{builtin
  versions}\DIFdelend \DIFaddbegin \DIFadd{a builtin
  version}\DIFaddend . This protocol is generally used \DIFdelbegin \DIFdel{to receive notifications from macOS
  bootloader, }\DIFdelend by the firmware\DIFaddbegin \DIFadd{, }\DIFaddend or by other
  applications\DIFaddbegin \DIFadd{, to receive notifications from the macOS bootloader}\DIFaddend .
...
\item
  ...
  \DIFdelbegin \DIFdel{version}\DIFdelend \DIFaddbegin \DIFadd{versions}\DIFaddend . Should be set to \texttt{true} to ensure UEFI Shell compatibility on
  platforms \DIFdelbegin \DIFdel{providing broken unicode collation . In general legacy }\DIFdelend \DIFaddbegin \DIFadd{with flawed unicode collation implementation. Legacy }\DIFaddend Insyde and APTIO
  platforms on Ivy Bridge\DIFdelbegin \DIFdel{and earlier are }\DIFdelend \DIFaddbegin \DIFadd{, and earlier, are typically }\DIFaddend affected.
