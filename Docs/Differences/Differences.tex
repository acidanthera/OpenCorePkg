...
%DIF ADD ../Configuration.tex        Sat Apr  4 23:12:10 2020
...
\item
  ...
  Ensure that CSM memory regions are marked as ACPI NVS to prevent \DIFdelbegin \DIFdel{boot.efi }\DIFdelend \DIFaddbegin \texttt{\DIFadd{boot.efi}} \DIFaddend or
  XNU from relocating or using them.
