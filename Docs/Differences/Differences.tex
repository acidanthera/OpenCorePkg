...
%DIF ADD ../Configuration.tex        Sat Mar 14 07:34:54 2020
...
\begin{itemize}
  ...
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{FwRuntimeServices}} \DIFaddbegin \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  ...
  used due to the lack of \texttt{RDRAND} instruction support.
  \item \href{https://github.com/acidanthera/audk}{\texttt{HiiDatabase}} \DIFaddbegin \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  ...
  \item \href{https://github.com/acidanthera/audk}{\texttt{NvmExpressDxe}} \DIFaddbegin \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  ...
  \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{AppleUsbKbDxe}} \DIFaddbegin \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  ...
  a security audit.
  \item \href{https://github.com/acidanthera/audk}{\texttt{XhciDxe}} \DIFaddbegin \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
...
To compile the drivers from UDK (EDK II) use the same command you \DIFdelbegin \DIFdel{do }\DIFdelend normally use
...
\DIFadd{To boot into Shell or any other tool directly save }\texttt{\DIFadd{Shell.efi}}
...
%DIF > sudo bless --verbose --file /Volumes/VOLNAME/DIR/Shell.efi \
...
\DIFadd{Some of the known tools are listed below:
}

\begin{itemize}
  \tightlist
  \DIFaddend \item 
  \DIFaddbegin \item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{BootKicker}} \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  --- Enter Apple BootPicker menu (exclusive for Macs with compatible GPUs).
  }\item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{ChipTune}} \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  --- Test BeepGen protocol and generate audio signals of different style and length.
  }\item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{CleanNvram}} \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  --- Reset NVRAM alternative bundled as a standalone tool.
  }\item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{FwProtect}} \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  --- Unlock and lock back NVRAM protection for other tools to be able to get full NVRAM access
  when launching from OpenCore.
  }\item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{GopStop}} \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  ...
  }\item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{HdaCodecDump}} \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  --- Parse and dump High Definition Audio codec information (requires }\texttt{\DIFadd{AudioDxe}}\DIFadd{).
  }\item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{KeyTester}} \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  --- Test keyboard input in }\texttt{\DIFadd{SimpleText}} \DIFadd{mode.
  }\item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{OpenCore Shell}} \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  --- OpenCore-configured }\href{http://github.com/tianocore/edk2}{\texttt{UEFI Shell}} \DIFadd{for compatibility
  with a broad range of firmwares.
  }\item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{PavpProvision}}
  \DIFadd{--- Perform EPID provisioning (requires certificate data configuration).
  }\item \href{https://github.com/acidanthera/OpenCorePkg}{\texttt{VerifyMsrE2}} \DIFadd{(}\textbf{\DIFadd{builtin}}\DIFadd{)
  --- Check }\texttt{\DIFadd{CFG Lock}} \DIFadd{(MSR }\texttt{\DIFadd{0xE2}} \DIFadd{write protection) consistency across all cores.
}\end{itemize}
...
\item
  ...
  using this option is advised on them as well\DIFaddbegin \DIFadd{.
}

\item
  \texttt{\DIFadd{AppleDebugLog}}\\
  \textbf{\DIFadd{Type}}\DIFadd{: }\texttt{\DIFadd{plist\ boolean}}\\
  \textbf{\DIFadd{Failsafe}}\DIFadd{: }\texttt{\DIFadd{false}}\\
