...
%DIF DEL PreviousConfiguration.tex   Mon Jul 22 10:33:06 2019
%DIF ADD ../Configuration.tex        Tue Jul 23 15:05:56 2019
...
\item
  \textbf{\DIFadd{Why do online recovery images (}\texttt{\DIFadd{*.dmg}} \DIFadd{fail to load?}}
  ...
  worked around with }\texttt{\DIFadd{AvoidHighAlloc}} \DIFadd{UEFI quirk}\DIFaddend .
