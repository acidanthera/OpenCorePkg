...
%DIF DEL PreviousConfiguration.tex   Sun Oct  4 16:48:52 2020
%DIF ADD ../Configuration.tex        Sun Oct  4 16:50:39 2020
...
configuration file format used to setup the correct functioning of \DIFaddbegin \DIFadd{the }\DIFaddend macOS
...
\item
  ...
  \begin{enumerate}
    ...
    \item Open \DIFdelbegin \DIFdel{your }\DIFdelend \DIFaddbegin \DIFadd{the }\DIFaddend firmware image in UEFITool and find \texttt{CFG Lock} unicode string.
      If it is not present, \DIFdelbegin \DIFdel{your }\DIFdelend \DIFaddbegin \DIFadd{the }\DIFaddend firmware may not have this option and \DIFdelbegin \DIFdel{you should stop}\DIFdelend \DIFaddbegin \DIFadd{the proccess should therefore be discontinued}\DIFaddend .
...
\begin{itemize}
  \item \DIFadd{All previous issues apply.
    ...
    }\href{https://mega.nz/folder/inRBTarD#zanf7fUbviwz3WHBU5xpCg}{here}\DIFadd{,
