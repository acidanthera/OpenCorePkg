...
%DIF ADD ../Configuration.tex        Sat Oct  3 13:41:05 2020
...
\item
  ...
  due to kext symbol tables being corrupted by the tools. This also makes
  }\texttt{\DIFadd{keepsyms=1}} \DIFadd{for kext frames broken on these systems.
}
...
\DIFdelend \DIFaddbegin \href{http://go.microsoft.com/fwlink/?LinkId=321194}{Microsoft UEFI Driver Signing CA} \DIFadd{will also be needed}\DIFaddend .
