...
%DIF ADD ../Configuration.tex        Tue Jan 12 22:24:07 2021
...
& USB mouse driver from \texttt{MdeModulePkg}. Some virtual machine firmware
  ...
  in UEFI graphical interfaces such as \texttt{OpenCanopy}. \\
\href{https://github.com/acidanthera/OpenCorePkg}{\DIFdelbegin \texttt{\DIFdel{VBoxHfs}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \texttt{\DIFadd{FswHfsPlus}}\DIFaddend }
