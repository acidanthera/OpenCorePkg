...
\texttt{icnspack}. Please refer to sample data for the details about the dimensions\DIFaddbegin \DIFadd{.
Font is Helvetica 12 pt times scale factor.
}

\DIFadd{Font format corresponds to }\href{https://www.angelcode.com/products/bmfont}{AngelCode binary BMF}\DIFadd{.
...
and }\href{https://github.com/usr-sse2/fonverter}{fonverter} \DIFadd{to export it to binary format}\DIFaddend .
