...
%DIF ADD ../Configuration.tex        Tue Jun 25 15:51:05 2019
...
\item
 ...
 \item
  ...
  \break
  \DIFdelbegin \DIFdel{8-bit integer }\DIFdelend \DIFaddbegin \DIFadd{One-byte data }\DIFaddend defining boot.efi user interface scaling. Should be 1 for normal
