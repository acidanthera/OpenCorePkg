...
%DIF ADD ../Configuration.tex        Mon Jan 11 15:18:33 2021
...
\item
  ...
  Macs when using }\texttt{\DIFadd{Automatic}} \DIFadd{PlatformInfo to avoid BIOS updates in macOS 11, Big Sur.
}
