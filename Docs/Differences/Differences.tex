...
%DIF ADD ../Configuration.tex        Wed Aug  7 21:30:05 2019
...
\DIFdelend \DIFaddbegin \href{https://github.com/acidanthera/AppleSupportPkg}{\texttt{FwRuntimeServices}}
  \DIFaddend --- \DIFdelbegin \DIFdel{a set of quirks for various firmwares.
  While it primarily targets APTIO
  firmwares, other firmwares may be compatible as well.Among the
  resolved issues
  are hibernation support, KASLR, Lilu NVRAM security enhancements, NVRAM, and UEFI
  Boot entry preservation}\DIFdelend \DIFaddbegin \texttt{\DIFadd{OC\_FIRMWARE\_RUNTIME}} \DIFadd{protocol implementation that increases the security
  ...
  target operating system, it cannot be implemented within OpenCore itself}\DIFaddend .
...
\item
  ...
  \href{https://github.com/acidanthera/bugtracker/issues/377}{acidanthera/bugtracker\#377}\DIFaddbegin \DIFadd{.
}
...
\item
  ...
  }\href{https://applelife.ru/posts/819790}{AppleLife.ru}\DIFaddend .
