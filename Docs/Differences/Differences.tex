...
%DIF ADD ../Configuration.tex        Tue Oct 12 02:10:19 2021
...
\item
  ...
  \DIFadd{Consider a GPU with 2 BARs:
    ...
    }\item \texttt{\DIFadd{BAR1}} \DIFadd{supports sizes from 1 MB to 256 MB. Its value is 256 MB.
  }\end{itemize}
  ...
  }\texttt{\DIFadd{BAR0}} \DIFadd{to 256 MB and }\texttt{\DIFadd{BAR0}} \DIFadd{to 1 MB.
  }\\
