...
\begin{titlepage}
   \begin{center}
       ...
       Reference Manual (0.5\DIFdelbegin \DIFdel{.0}\DIFdelend \DIFaddbegin \DIFadd{.1}\DIFaddend )
...
\item
  ...
  \href{https://github.com/acidanthera/OpenCoreShell}{UEFI Shell} \DIFdelbegin \DIFdel{or
  }%DIFDELCMD < \href{https://github.com/acidanthera/AppleSupportPkg#cleannvram}{CleanNvram} %%%
\DIFdelend are very
...
\item
  ...
  \DIFaddbegin \emph{\DIFadd{Note}}\DIFadd{: This field is best to be left empty on most firmwares.
}
...
\DIFaddend \item
  ...
  and \DIFdelbegin \DIFdel{and }\DIFdelend set different modes for the operating system booter (\texttt{ConsoleBehaviourOs}),
...
\item
  ...
  \emph{Note}: \DIFaddbegin \DIFadd{activated }\DIFaddend \texttt{\DIFdelbegin \DIFdel{AppleGenericInput}\DIFdelend \DIFaddbegin \DIFadd{KeySupport}\DIFaddend }, \texttt{UsbKbDxe}, or similar driver is required
...
\item
  ...
  Example: \texttt{\DIFdelbegin \DIFdel{CleanNvram}\DIFdelend \DIFaddbegin \DIFadd{Shell}\DIFaddend .efi}.
  \end{itemize}
...
\item
  ...
  \item \DIFdelbegin %DIFDELCMD < \href{https://github.com/acidanthera/AppleSupportPkg}{\texttt{AppleGenericInput}}
%DIFDELCMD <   %%%
\DIFdel{--- user input driver adding the support of }\texttt{\DIFdel{AppleKeyMapAggregator}} %DIFAUXCMD
\DIFdel{protocols
  on top of different UEFI input protocols. Additionally resolves mouse input issues
  on select firmwares. This is an alternative to }\texttt{\DIFdel{UsbKbDxe}}%DIFAUXCMD
\DIFdel{, which may work
  better or worse depending on the firmware.
  }%DIFDELCMD < \item %%%
\item%DIFAUXCMD
\DIFdelend \href{https://github.com/acidanthera/AppleSupportPkg}{\texttt{FwRuntimeServices}}
  ...
  \DIFaddbegin \DIFadd{builtin }\DIFaddend \texttt{\DIFdelbegin \DIFdel{AppleGenericInput}\DIFdelend \DIFaddbegin \DIFadd{KeySypport}\DIFaddend }, which may work better or worse depending on the firmware.
