...
%DIF ADD ../Configuration.tex        Tue Jun 18 11:21:04 2019
...
\item
  ...
  to be operating system agnostic, i.e. apply equally regardless of the OS booted\DIFaddbegin \DIFadd{.
}
  ...
  scope of this document and can be found online}\DIFaddend .
