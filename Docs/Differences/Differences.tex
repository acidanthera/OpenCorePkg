...
%DIF ADD ../Configuration.tex        Sat Oct  3 23:06:12 2020
...
\item
  ...
  \begin{itemize}
    ...
    \item \texttt{i386-user32} --- Use \texttt{i386} (32-bit) kernel when available
      ...
      processors, which cause some applications to crash on macOS~10.6. The behaviour
      corresponds to \texttt{-legacy} kernel boot argument.
