...
%DIF ADD ../Configuration.tex        Sun Mar 20 17:31:15 2022
...
\item
  ...
  \emph{\DIFadd{Note}}\DIFadd{: When this option is enabled, }\texttt{\DIFadd{DisableIoMapper}} \DIFadd{must be disabled and
  }\texttt{\DIFadd{VT-d}} \DIFadd{must be enabled in BIOS. Otherwise, network cards will not function correctly.
}
