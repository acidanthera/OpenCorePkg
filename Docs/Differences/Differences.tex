...
%DIF ADD ../Configuration.tex        Sun Feb 16 07:18:51 2020
...
\item
  ...
  \DIFadd{To see all entries picker menu needs to be reloaded by pressing one of the
  designated keys: }\texttt{\DIFadd{Escape}}\DIFadd{, }\texttt{\DIFadd{0}}\DIFadd{, }\texttt{\DIFadd{Spacebar}}\DIFadd{. Hiding
  auxiliary entries may increase boot performance for multidisk systems.
}
