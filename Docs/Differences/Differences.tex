...
%DIF ADD ../Configuration.tex        Sat Feb  1 15:39:25 2020
...
\item
  ...
  \DIFaddbegin \emph{\DIFadd{Note}}\DIFadd{: Some Macs like MacPro5,1 do have APFS compatibility, but their
  Apple Boot Policy protocol contains recovery detection issues, thus using
  this option is advised on them as well. 
}
