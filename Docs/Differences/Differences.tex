...
%DIF DEL PreviousConfiguration.tex   Sun May  3 11:04:53 2026
%DIF ADD ../Configuration.tex        Sun Sep 13 15:44:57 2026
...
\tightlist
  ...
  \item \DIFaddbegin \texttt{\DIFadd{OpticalDrive}} \DIFadd{--- Optical disc drive (128x128).
  }\item \DIFaddend \texttt{Other} --- Custom entry (see \texttt{Entries}, 128x128).
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Failsafe}: \texttt{false}\\
  \textbf{Description}: If \texttt{false} this driver entry will be ignored\DIFaddbegin \DIFadd{.
}
...
\item
  ...
  \textbf{\DIFadd{Description}}\DIFadd{: If }\texttt{\DIFadd{true}} \DIFadd{text output for this driver will be disabled}\DIFaddend .
