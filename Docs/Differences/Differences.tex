...
%DIF DEL PreviousConfiguration.tex   Fri Nov  5 22:16:18 2021
%DIF ADD ../Configuration.tex        Sat Nov 13 19:34:24 2021
...
\begin{titlepage}
   \begin{center}
       ...
       Reference Manual (0.7\DIFdelbegin \DIFdel{.5}\DIFdelend \DIFaddbegin \DIFadd{.6}\DIFaddend )
...
\item
  \DIFaddbegin \texttt{\DIFadd{LogModule}}\\
  ...
  When multiple ones are selected, comma (}\texttt{\DIFadd{,}}\DIFadd{) should be used as the splitter (e.g. }\texttt{\DIFadd{OCCPU,OCB,OCA}}\DIFadd{).
  }\texttt{\DIFadd{*}} \DIFadd{indicates all modules being logged.
}

  \emph{\DIFadd{Note}}\DIFadd{: Acronyms of libraries can be found in the
  }\hyperref[debug-target]{\texttt{Target}} \DIFadd{section below.
}
...
\item \DIFaddbegin \label{debug-target}
