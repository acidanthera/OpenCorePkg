...
%DIF ADD ../Configuration.tex        Fri Dec 10 14:56:58 2021
...
\DIFdel{: These patches currently target Microsoft Hyper-V and may need to be extended for other purposes.}\DIFdelend \DIFaddbegin \DIFadd{(10.8+).
