...
%DIF ADD ../Configuration.tex        Wed Jun 19 23:48:12 2019
...
\DIFaddbegin 
  ...
  \DIFadd{Loading Windows from OpenCore may lead to the need of reactivation. To avoid it consider
  ...
  direction }\texttt{\DIFadd{FlipFlopWheel}} \DIFadd{must be set to }\texttt{\DIFadd{1}} \DIFadd{as explained on
  }\href{https://superuser.com/a/364353}{SuperUser}\DIFadd{. Similarly }\texttt{\DIFadd{RealTimeIsUniversal}}
  \DIFadd{must be set to }\texttt{\DIFadd{1}} \DIFadd{to avoid time desync between Windows and macOS as explained
  on }\href{https://superuser.com/q/494432}{SuperUser} \DIFadd{(this one is usually not needed).
}
