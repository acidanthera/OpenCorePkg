...
%DIF ADD ../Configuration.tex        Sat Sep  7 17:24:42 2019
...
\item
  ...
  to try to use largest available console mode\DIFaddbegin \DIFadd{.
}

  \emph{\DIFadd{Note}}\DIFadd{: This field is best to be left empty on most firmwares}\DIFaddend .
