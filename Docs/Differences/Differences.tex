...
%DIF DEL PreviousConfiguration.tex   Sun Mar 28 23:20:53 2021
%DIF ADD ../Configuration.tex        Sun Mar 28 23:20:53 2021
...
\item
  ...
  for graphical user interface. \DIFdelbegin \DIFdel{See }\DIFdelend \DIFaddbegin \DIFadd{Refer to }\DIFaddend the \hyperref[ueficanopy]{OpenCanopy} section for more details.
\item
  \texttt{Tools} \\
...
\item
  ...
  \DIFdelbegin \DIFdel{See }\DIFdelend \DIFaddbegin \DIFadd{Refer to }\DIFaddend the \hyperref[acpipropsadd]{Add Properties} section below.
...
\item
  ...
  \DIFdelbegin \DIFdel{See }\DIFdelend \DIFaddbegin \DIFadd{Refer to }\DIFaddend the \hyperref[acpipropsdelete]{Delete Properties} section below.
...
\item
  ...
  \DIFdelbegin \DIFdel{See }\DIFdelend \DIFaddbegin \DIFadd{Refer to }\DIFaddend the \hyperref[acpipropspatch]{Patch Properties} section below.
...
\item
  ...
  \DIFdelbegin \DIFdel{See }\DIFdelend \DIFaddbegin \DIFadd{Refer to }\DIFaddend the \hyperref[booterpropsmmio]{MmioWhitelist Properties} section below.
...
\item
  ...
  patch. \DIFdelbegin \DIFdel{See }\DIFdelend \DIFaddbegin \DIFadd{Refer to }\DIFaddend the \hyperref[booterpropspatch]{Patch Properties} section below.
...
\DIFdelbegin \DIFdel{Kernel driver load order follows the item order in the array, thus the dependencies should be written
  ...
  key in the \texttt{Info.plist} \DIFaddbegin \DIFadd{file }\DIFaddend of the kext \DIFaddbegin \DIFadd{being added}\DIFaddend . Any kext \DIFdelbegin \DIFdel{mentioned }\DIFdelend \DIFaddbegin \DIFadd{included
  }\DIFaddend in the \texttt{OSBundleLibraries} \DIFdelbegin \DIFdel{of the other kext must precede
  this kext }\DIFdelend \DIFaddbegin \DIFadd{key is a dependency that must precede
  the kext being added}\DIFaddend .

  \emph{Note \DIFaddbegin \DIFadd{3}\DIFaddend }: Kexts may have inner kexts (\texttt{\DIFdelbegin \DIFdel{Plug-Ins}\DIFdelend \DIFaddbegin \DIFadd{Plugins}\DIFaddend }) \DIFdelbegin \DIFdel{in their bundle . Each
  inner kext }\DIFdelend \DIFaddbegin \DIFadd{included
  in the bundle and each such plugin }\DIFaddend must be added separately.
...
\item
  ...
  Refer to }\DIFaddend the \hyperref[kernelpropsblock]{Block Properties} section below.
...
\item
  ...
  See }\DIFdelend \DIFaddbegin \DIFadd{kext.
  Refer to }\DIFaddend the \hyperref[kernelpropsforce]{Force Properties} section below.
...
\item
  ...
  \DIFdelbegin \DIFdel{See }\DIFdelend \DIFaddbegin \DIFadd{Refer to }\DIFaddend the \hyperref[kernelpropspatch]{Patch Properties} section below.
...
\item
  ...
  \DIFdelbegin \DIFdel{See }\DIFdelend \DIFaddbegin \DIFadd{Refer to }\DIFaddend the \hyperref[miscentryprops]{Entry Properties} section below.
...
}\DIFaddend as NVRAM variables. Refer to \texttt{man\ nvram} for more details.
\DIFdelbegin \DIFdel{macOS }\DIFdelend \DIFaddbegin \DIFadd{The macOS operating system }\DIFaddend extensively uses NVRAM variables for OS --- Bootloader
...
\item
  ...
  \DIFdelbegin \DIFdel{See }\DIFdelend \DIFaddbegin \DIFadd{Refer to }\DIFaddend the \hyperref[uefirsvdprops]{ReservedMemory Properties} section below.
...
\item
  ...
  }\DIFaddend \href{https://developer.apple.com/support/apple-file-system/Apple-File-System-Reference.pdf}{Apple File System Reference} \DIFaddbegin \DIFadd{for more details}\DIFaddend .
...
\item
  ...
  \item
  \DIFaddbegin \texttt{\DIFadd{KeySkipFirstDelay}}\\
  \textbf{\DIFadd{Type}}\DIFadd{: }\texttt{\DIFadd{plist\ boolean}}\\
  \textbf{\DIFadd{Failsafe}}\DIFadd{: }\texttt{\DIFadd{false}}\\
  \textbf{\DIFadd{Description}}\DIFadd{: Suppress initial delay before key repeat in
  OpenCore implementation of Apple Event protocol.
}

  \DIFadd{When combining OpenCore }\texttt{\DIFadd{KeySupport}} \DIFadd{with the Apple Event protocol, key repeat behaviour
  ...
  implementation. This option is recommended to be set when using }\texttt{\DIFadd{KeySupport}} \DIFadd{mode, in most
  cases, and is not recommended to be set on any systems which are not using }\texttt{\DIFadd{KeySupport}} \DIFadd{mode.
}
