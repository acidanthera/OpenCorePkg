...
%DIF ADD ../Configuration.tex        Sun Feb 14 16:01:13 2021
...
\DIFaddbegin 
  ...
  \DIFadd{Specify }\texttt{\DIFadd{OEM}} \DIFadd{value to extract current value from NVRAM
  ...
  \DIFaddbegin \DIFadd{Specify }\texttt{\DIFadd{OEM}} \DIFadd{value to extract current value from NVRAM
