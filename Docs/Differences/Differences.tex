...
%DIF DEL PreviousConfiguration.tex   Thu Oct 17 01:43:10 2019
%DIF ADD ../Configuration.tex        Thu Oct 17 20:15:30 2019
...
\begin{titlepage}
   \begin{center}
       ...
       Reference Manual (0.5\DIFdelbegin \DIFdel{.1}\DIFdelend \DIFaddbegin \DIFadd{.2}\DIFaddend )
...
\item
  ...
  automatic booting of the default boot entry\DIFaddbegin \DIFadd{. Use 0 to disable timer}\DIFaddend .
