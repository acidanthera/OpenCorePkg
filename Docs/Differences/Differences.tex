...
%DIF DEL PreviousConfiguration.tex   Sat Sep 11 00:38:52 2021
%DIF ADD ../Configuration.tex        Mon Sep 13 16:54:52 2021
...
\begin{itemize}
  ...
  \tightlist
    ...
    distros only, use \texttt{partuuidopts:\{partuuid\}+=ro} instead of this flag\DIFaddbegin \DIFadd{.
	  }\item \texttt{\DIFadd{0x00004000}} \DIFadd{(bit }\texttt{\DIFadd{14}}\DIFadd{) --- }\texttt{\DIFadd{LINUX\_BOOT\_LOG\_VERBOSE}}\DIFadd{,
	  Add additional debug log info about files encountered and autodetect options added while scanning for
    Linux boot entries}\DIFaddend .
