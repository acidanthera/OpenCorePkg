...
%DIF DEL PreviousConfiguration.tex   Wed Mar 17 04:20:17 2021
%DIF ADD ../Configuration.tex        Wed Mar 17 04:24:07 2021
...
\item
  ...
  manner from within the OpenCore picker. Such extensions include support for tapping on keys in
  addition to holding and pressing \texttt{Shift} along with other keys instead of only
  pressing the \texttt{Shift} key, which is not detectable on many PS/2 keyboards.
