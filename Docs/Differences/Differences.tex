...
%DIF DEL PreviousConfiguration.tex   Wed Feb 17 07:05:03 2021
%DIF ADD ../Configuration.tex        Thu Feb 18 09:07:56 2021
...
any \DIFdelbegin \DIFdel{stock textual editor (e.g. nano , vim), but }\DIFdelend \DIFaddbegin \DIFadd{text editor such as nano and vim. However, }\DIFaddend specialised software may provide
\DIFaddbegin \DIFadd{a }\DIFaddend better experience. On macOS\DIFaddbegin \DIFadd{, }\DIFaddend the preferred GUI application is
...
For BIOS booting\DIFaddbegin \DIFadd{, }\DIFaddend a third-party UEFI environment provider will have to
...
information about changes to the configuration as }\DIFaddend compared to the previous release
\DIFdelbegin \DIFdel{, and }\DIFdelend \DIFaddbegin \DIFadd{as well as to the }\DIFaddend \texttt{Changelog.md} document, \DIFdelbegin \DIFdel{containing
...
\DIFdelbegin \DIFdel{Currently }\DIFdelend \DIFaddbegin \DIFadd{The currently }\DIFaddend supported EDK II release is hosted in
...
files must ensure that their tool checks \DIFdelbegin \DIFdel{for }\DIFdelend \DIFaddbegin \DIFadd{the }\DIFaddend \texttt{opencore-version} NVRAM variable
(see \hyperref[miscdebugprops]{Debug Properties} section below) and \DIFdelbegin \DIFdel{warn the user
}\DIFdelend \DIFaddbegin \DIFadd{warns users
...
across \DIFdelbegin \DIFdel{the releases and the tool shall ensure that it carefully follows }\DIFdelend \DIFaddbegin \DIFadd{releases and such tools shall ensure they carefully follow }\DIFaddend this document. Failure
