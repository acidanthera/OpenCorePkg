...
%DIF ADD ../Configuration.tex        Sun Jun 16 17:40:46 2019
...
\item
  ...
  \textbf{Type}: \texttt{plist\ boolean}\\
  \textbf{Default value}: \texttt{\DIFdelbegin \DIFdel{NO}\DIFdelend \DIFaddbegin \DIFadd{false}\DIFaddend }\\
...
\item
  ...
  \textbf{\DIFadd{Type}}\DIFadd{: }\texttt{\DIFadd{plist\ string}}\\
  \textbf{\DIFadd{Default value}}\DIFadd{: Empty string}\\
