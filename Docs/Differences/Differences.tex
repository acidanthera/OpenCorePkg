...
%DIF ADD ../Configuration.tex        Sun Jun 27 15:12:54 2021
...
\begin{titlepage}
   \begin{center}
       ...
       Reference Manual (0.7\DIFdelbegin \DIFdel{.0}\DIFdelend \DIFaddbegin \DIFadd{.1}\DIFaddend )
...
\DIFaddbegin \item
  \texttt{\DIFadd{SyncTableIds}}\\
  \textbf{\DIFadd{Type}}\DIFadd{: }\texttt{\DIFadd{plist\ boolean}}\\
  \textbf{\DIFadd{Failsafe}}\DIFadd{: }\texttt{\DIFadd{false}}\\
  \textbf{\DIFadd{Description}}\DIFadd{: Sync table identifiers with the }\texttt{\DIFadd{SLIC}} \DIFadd{table.
}

  \DIFadd{This works around patched tables becoming incompatible with the }\texttt{\DIFadd{SLIC}}
  \DIFadd{table causing licensing issues in older Windows operating systems.
}
...
across all cores and change such hidden options on selected platforms. \DIFaddbegin \\
\href{https://github.com/acidanthera/OpenCorePkg}{\texttt{\DIFadd{TpmInfo}}}\textbf{\DIFadd{*}}
& \DIFadd{Check Intel PTT (Platform Trust Technology) capability on the platform,
