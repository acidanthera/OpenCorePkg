...
%DIF DEL PreviousConfiguration.tex   Wed Feb  3 07:25:06 2021
%DIF ADD ../Configuration.tex        Sat Feb  6 16:30:19 2021
...
\DIFdelend \DIFaddbegin \DIFadd{0 (Search entire ACPI table)}\DIFaddend \\
...
\item
  ...
  \textbf{Type}: \texttt{plist\ integer}\\
  \textbf{Failsafe}: \DIFdelbegin \texttt{\DIFdel{0}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{0 (Search the entire booter)}\DIFaddend \\
  \textbf{Description}: Maximum number of bytes to search for.
\DIFdelbegin \DIFdel{Can be set to
  }\texttt{\DIFdel{0}} %DIFAUXCMD
...
\item
  ...
  Allows fuzzy search by ignoring not masked (set to zero) bits.
  \DIFdelbegin \DIFdel{Can be
  set to empty data to be ignored. }\DIFdelend Must equal to \texttt{Find} in size \DIFdelbegin \DIFdel{otherwise}\DIFdelend \DIFaddbegin \DIFadd{if set}\DIFaddend .
...
\item
  ...
  replacement) by obtaining the address of provided symbol name. \DIFdelbegin \DIFdel{Can be set to }\DIFdelend \DIFaddbegin \DIFadd{Set to an }\DIFaddend empty string
  to \DIFdelbegin \DIFdel{be ignored}\DIFdelend \DIFaddbegin \DIFadd{ignore}\DIFaddend .
...
\item
  ...
  \textbf{Type}: \texttt{plist\ integer}\\
  \textbf{Failsafe}: \DIFdelbegin \texttt{\DIFdel{0}}%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{0 (Search entire kext or kernel)}\DIFaddend \\
  \textbf{Description}: Maximum number of bytes to search for.
\DIFdelbegin \DIFdel{Can be set to
  }\texttt{\DIFdel{0}} %DIFAUXCMD
...
\item
  ...
  Allows fuzzy search by ignoring not masked (set to zero) bits.
  \DIFdelbegin \DIFdel{Can be
  set to empty data to be ignored. }\DIFdelend Must equal to \texttt{Replace} in size \DIFdelbegin \DIFdel{otherwise}\DIFdelend \DIFaddbegin \DIFadd{if set}\DIFaddend .
...
\item
  ...
  \textbf{Type}: \texttt{plist\ integer}, 32-bit\\
  \textbf{Failsafe}: \DIFdelbegin \DIFdel{Not installed}\DIFdelend \DIFaddbegin \DIFadd{0 (Not installed)}\DIFaddend \\
...
\item
  \texttt{BoardType}\\
  \textbf{Type}: \texttt{plist\ integer}\\
  \textbf{Failsafe}: \DIFdelbegin \DIFdel{OEM specified}\DIFdelend \DIFaddbegin \DIFadd{0 (OEM specified)}\DIFaddend \\
...
\item
  ...
  Set to \DIFdelbegin \DIFdel{empty string not to change }\DIFdelend \DIFaddbegin \DIFadd{an empty string to maintain current }\DIFaddend console mode. Set to \texttt{Max}
  to \DIFdelbegin \DIFdel{try to use }\DIFdelend \DIFaddbegin \DIFadd{attempt using the }\DIFaddend largest available console mode. \DIFdelbegin \DIFdel{Currently
  }\DIFdelend \DIFaddbegin \DIFadd{This option is currently
  ignored as the }\DIFaddend \texttt{Builtin} text renderer \DIFdelbegin \DIFdel{supports only }\DIFdelend \DIFaddbegin \DIFadd{only supports }\DIFaddend one console mode\DIFdelbegin \DIFdel{, so
...
\item
  ...
  \item Set to \DIFdelbegin \DIFdel{empty string not to change }\DIFdelend \DIFaddbegin \DIFadd{an empty string to maintain the current }\DIFaddend screen resolution.
  \item Set to \texttt{Max} to \DIFdelbegin \DIFdel{try to use }\DIFdelend \DIFaddbegin \DIFadd{attempt using the }\DIFaddend largest available screen resolution.
  \end{itemize}
...
\item
  ...
  \emph{Note}: This option only applies to \texttt{System} renderer.
   ...
   \DIFaddbegin \DIFadd{an }\DIFaddend empty string for this to work.
...
\item
  ...
  versions. This protocol is generally used \DIFdelbegin \DIFdel{to receive notifications from macOS
