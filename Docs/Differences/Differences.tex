...
%DIF ADD ../Configuration.tex        Sat Feb  1 15:29:18 2020
...
\item
  ...
  version. This may be used to ensure APFS compatibility on VMs or legacy Macs\DIFaddbegin \DIFadd{.
}

  \emph{\DIFadd{Note}}\DIFadd{: Some Macs like MacPro5,1 do have APFS compatibility, but their
  Apple Boot Policy protocol contains recovery detection issues, thus using
  this option is advised on them as well}\DIFaddend . 
