...
%DIF ADD ../Configuration.tex        Sun Jan 10 22:01:06 2021
...
\item
  \DIFaddbegin \texttt{\DIFadd{BIOSVersion}}\\
  \textbf{\DIFadd{Type}}\DIFadd{: }\texttt{\DIFadd{plist\ string}}\\
  \textbf{\DIFadd{Failsafe}}\DIFadd{: }\texttt{\DIFadd{Auto}}\\
  \textbf{\DIFadd{SMBIOS}}\DIFadd{: BIOS Information (Type 0) --- BIOS Version}\\
  \textbf{\DIFadd{Description}}\DIFadd{: Refer to SMBIOS }\texttt{\DIFadd{BIOSVersion}}\DIFadd{.
}
...
\texttt{icnspack}\DIFdelbegin \DIFdel{. Please refer to sample data for the details about the dimensions}\DIFdelend . Font is Helvetica 12 pt times scale factor.
