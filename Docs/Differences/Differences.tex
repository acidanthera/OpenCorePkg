...
%DIF DEL PreviousConfiguration.tex   Mon Jun 22 01:30:23 2020
%DIF ADD ../Configuration.tex        Mon Jun 22 04:10:28 2020
...
%DIF > git clone --recursive https://github.com/acidanthera/audk UDK
cd UDK
...
\item
  ...
  \DIFadd{This option overrides the maximum slide instead of }\texttt{\DIFadd{TOTAL\_SLIDE\_NUM}}
  \DIFadd{(255) when }\texttt{\DIFadd{ProvideCustomSlide}} \DIFadd{is enabled. It is believed that modern
