...
%DIF ADD ../Configuration.tex        Fri Apr 21 11:04:21 2023
...
\item
  ...
  where the native DMAR table does not contain any Reserved Memory Regions.
}
...
\item
  ...
  for text rendering. \texttt{Builtin} \DIFdelbegin \DIFdel{bypassing }\DIFdelend \DIFaddbegin \DIFadd{bypasses }\DIFaddend firmware services
...
\item
  ...
  is \texttt{false}\DIFaddbegin \DIFadd{.
}

  \emph{\DIFadd{Note 2}}\DIFadd{: On most systems from circa 2013 onwards, write-combining
  ...
  please log a bugtracker issue if such a system is found}\DIFaddend .
