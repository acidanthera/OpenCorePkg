...
\item
  ...
  \emph{Note}: This option is deprecated and will be removed in the newer OpenCore
  ...
  \href{https://github.com/acidanthera/bugtracker}{Acidanthera Bugtracker} if you need this option.
