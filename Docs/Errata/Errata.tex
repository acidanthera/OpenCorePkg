...
\item
  \textbf{Identifier}: \texttt{ERR001-1} \\
  \textbf{Published}: 2025-10-10 10:38 BST \\
  \textbf{Updated}: 2025-10-10 10:38 BST \\
  ...
  \begin{itemize}
    ...
    \item Use RELEASE rather the DEBUG build of OpenDuet if launching Grub 2 on a system with
