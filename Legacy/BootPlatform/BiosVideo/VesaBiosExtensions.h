...
#define VESA_BIOS_EXTENSIONS_DETAILED_TIMING_DESCRIPTOR_COUNT         \
  (VESA_BIOS_EXTENSIONS_DETAILED_TIMING_DESCRIPTOR_MAX_SIZE / VESA_BIOS_EXTENSIONS_DETAILED_TIMING_EACH_DESCRIPTOR_SIZE)
