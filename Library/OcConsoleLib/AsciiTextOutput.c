...
#define ISO_CHAR_MAX    0x7F
#define ISO_CHAR_WIDTH  8
#define ISO_CHAR_HEIGHT 16
#define ISO_CHAR_BPP    32

STATIC UINT8 mIsoFontData[(ISO_CHAR_MAX + 1)*ISO_CHAR_HEIGHT] = {
  ...
  )
{
  ...
  if ((UINT32) Char > ISO_CHAR_MAX) {
    Char = L'_';
  }

  DstBuffer = Buffer;
  SrcBuffer = mIsoFontData + (Char * ISO_CHAR_HEIGHT);
