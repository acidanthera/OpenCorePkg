/** @file
   ...
   approach for automatic protocol installation.
...
/**
   Install SimpleTextInputEx compatibility protocol using standard registration.

   This function uses the standard gBS->InstallProtocolInterface method for
   protocol installation, making it suitable for use within OpenShell.
...
{
  // Call the internal implementation with standard registration
