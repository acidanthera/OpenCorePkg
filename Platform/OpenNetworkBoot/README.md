...
Since a May 2024 security update to the network boot stack, OVMF's native
network boot support, compiled as above, requires the qemu option
`-device virtio-rng-pci`. For more information, see the section on RNG
Support in the Network Boot Stack, below.
