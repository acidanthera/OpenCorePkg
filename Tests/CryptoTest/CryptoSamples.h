...
const CHAR8  Sample5[] = "Jefe\0";
const CHAR8  Sample6[] = "what do ya want for nothing?\0";
...
//
STATIC HASH_SAMPLE  HashSamples[HASH_SAMPLES_NUM] = {
  {
    (UINT8 *)Sample1,
    11,
    {
...
STATIC HMAC_SAMPLE  HmacSamples[HMAC_SAMPLES_NUM] = {
  {
    (UINT8 *)Sample5,
    4,
    (UINT8 *)Sample6,
    ...
    //
    {
      0x75, 0x0c, 0x78, 0x3e, 0x6a, 0xb0,
      0xb5, 0x03, 0xea, 0xa8, 0x6e, 0x31,
      0x0a, 0x5d, 0xb7, 0x38
    },
    //
    // HMAC-SHA1 (RFC 2202 #2)
    //
    {
    ...
    //
    // HMAC-SHA512 (RFC 4231 #2)
    //
    {
      0x16, 0x4b, 0x7a, 0x7b, 0xfc, 0xf8,
      0x19, 0xe2, 0xe3, 0x95, 0xfb, 0xe7,
      0x3b, 0x56, 0xe0, 0xa3, 0x87, 0xbd,
      0x64, 0x22, 0x2e, 0x83, 0x1f, 0xd6,
      0x10, 0x27, 0x0c, 0xd7, 0xea, 0x25,
      0x05, 0x54, 0x97, 0x58, 0xbf, 0x75,
      0xc0, 0x5a, 0x99, 0x4a, 0x6d, 0x03,
      0x4f, 0x65, 0xf8, 0xf0, 0xe6, 0xfd,
      0xca, 0xea, 0xb1, 0xa3, 0x4d, 0x4a,
      0x6b, 0x4b, 0x63, 0x6e, 0x07, 0x0a,
      0x38, 0xbc, 0xe7, 0x37
    },
    //
    // HMAC-SHA384 (RFC 4231 #2)
    //
    {
      0xaf, 0x45, 0xd2, 0xe3, 0x76, 0x48,
      0x40, 0x31, 0x61, 0x7f, 0x78, 0xd2,
      0xb5, 0x8a, 0x6b, 0x1b, 0x9c, 0x7e,
      0xf4, 0x64, 0xf5, 0xa0, 0x1b, 0x47,
      0xe4, 0x2e, 0xc3, 0x73, 0x63, 0x22,
      0x44, 0x5e, 0x8e, 0x22, 0x40, 0xca,
      0x5e, 0x69, 0xe2, 0xc7, 0x8b, 0x32,
