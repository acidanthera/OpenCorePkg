...
KEXT_INFO mKextInfo[] = {
  ...
  { "FeatureUnlock.kext",                                                   "Contents/MacOS/FeatureUnlock",       "Contents/Info.plist" },
  ...
  { "WebCamera.kext",                                                       "",                                   "Contents/Info.plist" },
  { "UEFIGraphicsFB.kext",                                                  "Contents/MacOS/UEFIGraphicsFB",      "Contents/Info.plist" },
